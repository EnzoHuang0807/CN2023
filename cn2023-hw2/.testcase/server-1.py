...
if __name__ == '__main__':
    ...
    assert(req.status_code == 200)
    cmpFile('assets/files/alargerfile', '../hw2/web/files/alargerfile')
    ...
    assert(req.status_code == 200)
    cmpFile('assets/files/averylargefile', '../hw2/web/files/averylargefile')
    ...
    assert(req.status_code == 200)
    cmpFile('assets/files/a STaRanG3 F1le', '../hw2/web/files/a STaRanG3 F1le')
    ...
    cmpFile('assets/download/a STaRanG3 F1le', '../hw2/web/files/a STaRanG3 F1le')
    
    delPath('assets/files')
    delPath('assets/download')
    delPath('../hw2/web/files')
    delPath('../hw2/web/videos')
    delPath('../hw2/web/tmp')
